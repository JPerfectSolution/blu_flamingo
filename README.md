...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/thriveweb/bluflamingo&stack=cms)
...
- Give your zap a name, example: "Automatic deploy bluflamingo" and make sure your zap is turned on
...
- Now go to the [form settings](https://app.netlify.com/sites/bluflamingo/settings/forms#outgoing-notifications) in you Netlify project
